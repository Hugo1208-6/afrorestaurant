  ...
  return (
    ...
    flex flex-col z-[101]'>
        <div className='w-full flex items-center justify-between p-4 cursor-pointer'>
            ...
            cursor-pointer text-textColor text-base' onClick={clearCart}>clear <RiRefreshFill/> {""}
            </motion.p>
        </div>
         {/*bottom section  */}
         {cartItems && cartItems.length > 0 ? (
           <div className='w-full h-full bg-cartBg
            ...
            {/* cart items  section */}
                ...
                flex-col gap-3 overflow-scroll scrollbar-none'>
                    {/* Cart Item */}
                ...
                <div className='w-full flex-1 bg-cartTotal
                 rounded-t-[2rem] flex flex-col item-center justify-evenly px-8 py-2'>
                   ...
                   {user ? ( <motion.button
                        ...
                        className='w-full p-2 rounded-full
                          bg-gradient-to-tr from-orange-400 to-orange-600 text-gray-50 text-lg my-2
                          hover:shadow-lg'>
                            Check out
